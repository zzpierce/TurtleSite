...
public class ZImage {
     ...
     * @param imageFilePath
     */
    public ZImage(String imageFilePath) {
    ...
    public void flipHorizontally(){
        ...
        Image from = bufferedImage.getScaledInstance(width, height, Image.SCALE_DEFAULT);

        g2d.drawImage(from, width, 0, 0, height, 0, 0, width, height, null);
        g2d.dispose();
        bufferedImage = to;
    }
    ...
    public void combineWithPicture(ZImage image2){
        combineWithPicture(image2.getAsBufferedImage(), 2, null);
    }
    public void combineWithPicture(ZImage image2, int jump){
        combineWithPicture(image2.getAsBufferedImage(), jump, null);
    }

    public void combineWithPicture(ZImage image2, Color ignoreColor){
        combineWithPicture(image2.getAsBufferedImage(), 2, ignoreColor);
    }
    public void combineWithPicture(ZImage image2, int jump, Color ignoreColor){
